...
write.csv(LR_PostProbs,"Scenario6_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario6_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario6_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario6_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario6_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario6_LMROB_Betas.csv")
