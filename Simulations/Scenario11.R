...
write.csv(LR_PostProbs,"Scenario11_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario11_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario11_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario11_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario11_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario11_LMROB_Betas.csv")
