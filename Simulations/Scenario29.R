...
write.csv(LR_PostProbs,"Scenario29_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario29_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario29_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario29_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario29_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario29_LMROB_Betas.csv")
