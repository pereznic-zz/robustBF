...
write.csv(LR_PostProbs,"Scenario10_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario10_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario10_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario10_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario10_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario10_LMROB_Betas.csv")
