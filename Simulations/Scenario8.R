...
highYDatasets<-outliers_Y(normalDatasets,n_outliers,minValIQR,maxValIQR)

# set data to use
currentData<-highYDatasets
...
write.csv(LR_PostProbs,"Scenario8_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario8_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario8_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario8_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario8_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario8_LMROB_Betas.csv")
