...
write.csv(LR_PostProbs,"Scenario2_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario2_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario2_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario2_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario2_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario2_LMROB_Betas.csv")
