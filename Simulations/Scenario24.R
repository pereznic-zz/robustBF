...
write.csv(LR_PostProbs,"Scenario24_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario24_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario24_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario24_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario24_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario24_LMROB_Betas.csv")
