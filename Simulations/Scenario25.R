...
write.csv(LR_PostProbs,"Scenario25_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario25_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario25_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario25_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario25_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario25_LMROB_Betas.csv")
