...
write.csv(LR_PostProbs,"Scenario1_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario1_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario1_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario1_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario1_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario1_LMROB_Betas.csv")
