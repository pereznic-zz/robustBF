...
write.csv(LR_PostProbs,"Scenario14_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario14_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario14_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario14_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario14_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario14_LMROB_Betas.csv")
