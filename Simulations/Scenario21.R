...
write.csv(LR_PostProbs,"Scenario21_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario21_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario21_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario21_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario21_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario21_LMROB_Betas.csv")
