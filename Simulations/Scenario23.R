...
write.csv(LR_PostProbs,"Scenario23_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario23_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario23_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario23_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario23_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario23_LMROB_Betas.csv")
