...
write.csv(LR_PostProbs,"Scenario19_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario19_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario19_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario19_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario19_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario19_LMROB_Betas.csv")
