...
write.csv(LR_PostProbs,"Scenario13_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario13_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario13_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario13_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario13_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario13_LMROB_Betas.csv")
