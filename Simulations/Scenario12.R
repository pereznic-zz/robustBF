...
write.csv(LR_PostProbs,"Scenario12_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario12_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario12_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario12_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario12_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario12_LMROB_Betas.csv")
