...
write.csv(LR_PostProbs,"Scenario18_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario18_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario18_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario18_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario18_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario18_LMROB_Betas.csv")
