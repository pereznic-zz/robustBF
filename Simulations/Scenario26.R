...
write.csv(LR_PostProbs,"Scenario26_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario26_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario26_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario26_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario26_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario26_LMROB_Betas.csv")
