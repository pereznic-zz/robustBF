...
write.csv(LR_PostProbs,"Scenario22_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario22_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario22_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario22_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario22_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario22_LMROB_Betas.csv")
