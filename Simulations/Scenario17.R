...
write.csv(LR_PostProbs,"Scenario17_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario17_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario17_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario17_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario17_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario17_LMROB_Betas.csv")
