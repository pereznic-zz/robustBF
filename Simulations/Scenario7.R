...
write.csv(LR_PostProbs,"Scenario7_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario7_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario7_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario7_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario7_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario7_LMROB_Betas.csv")
