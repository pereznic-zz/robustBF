...
write.csv(LR_PostProbs,"Scenario28_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario28_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario28_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario28_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario28_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario28_LMROB_Betas.csv")
