...
write.csv(LR_PostProbs,"Scenario20_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario20_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario20_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario20_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario20_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario20_LMROB_Betas.csv")
