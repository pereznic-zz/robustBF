...
lowXDatasets<-outliers_X(normalDatasets,n_outliers,coeffs,minValIQR,maxValIQR)

# set data to use
currentData<-lowXDatasets
...
write.csv(LR_PostProbs,"Scenario5_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario5_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario5_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario5_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario5_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario5_LMROB_Betas.csv")
