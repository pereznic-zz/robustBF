...
write.csv(LR_PostProbs,"Scenario9_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario9_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario9_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario9_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario9_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario9_LMROB_Betas.csv")
