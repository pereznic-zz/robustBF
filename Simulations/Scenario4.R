...
write.csv(LR_PostProbs,"Scenario4_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario4_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario4_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario4_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario4_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario4_LMROB_Betas.csv")
