...
write.csv(LR_PostProbs,"Scenario30_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario30_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario30_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario30_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario30_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario30_LMROB_Betas.csv")
