...
write.csv(LR_PostProbs,"Scenario16_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario16_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario16_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario16_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario16_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario16_LMROB_Betas.csv")
