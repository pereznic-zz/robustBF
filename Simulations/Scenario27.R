...
write.csv(LR_PostProbs,"Scenario27_LR_Probs.csv")
write.csv(RLM_PostProbs,"Scenario27_RLM_Probs.csv")
write.csv(LMROB_PostProbs,"Scenario27_LMROB_Probs.csv")
write.csv(LR_results[[1]],"Scenario27_LR_Betas.csv")
write.csv(RLM_results[[1]],"Scenario27_RLM_Betas.csv")
write.csv(LMROB_results[[1]],"Scenario27_LMROB_Betas.csv")
